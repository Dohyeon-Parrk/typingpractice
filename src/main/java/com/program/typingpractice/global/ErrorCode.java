...
public enum ErrorCode {
    ...
    // 회원 관련 예외
    EMAIL_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 사용 중인 이메일 입니다."),
    USERNAME_ALREADY_EXISTS(HttpStatus.CONFLICT, "이미 사용 중인 닉네임 입니다."),
    INVALID_EMAIL_FORMAT(HttpStatus.BAD_REQUEST, "올바른 이메일 형식을 입력해 주세요."),
    USERNAME_REQUIRED(HttpStatus.BAD_REQUEST, "유저네임은 필수 입력 사항 입니다."),
